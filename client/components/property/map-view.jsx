...
export function MapView({ properties, height = "400px", defaultCenter }) {
    ...
    return (_jsx("div", { className: "overflow-hidden rounded-lg border border-base-300 shadow-sm relative z-0", style: { height }, children: _jsx("div", { ref: mapContainerRef, className: "h-full w-full bg-base-300" }) }));
}

      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_380px]">
        <div className="space-y-6">
          ...
          <div className="panel p-7">
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="rounded-lg border border-base-300/70 bg-base-200/70 px-6 py-4 text-right">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <div className="rounded-lg border border-base-300/70 bg-base-200/70 p-4">
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {property.amenities.map((amenity) => (
                  <div key={amenity} className="flex items-center gap-3 rounded-md border border-base-300 bg-white px-4 py-3">
        ...
        <div className="space-y-6 lg:sticky lg:top-24 lg:self-start">
          <div className="panel p-6">
            ...
            <div className="mt-5 rounded-lg bg-base-200 p-4 text-sm text-base-content/70">
              Call, WhatsApp, or request a callback without filling a long form.
            </div>
            <div className="mt-4 flex flex-wrap gap-2">
              <CompareButton propertyId={property.id} />
            </div>
            {property.occupancyDetails ? (
              <div className="mt-4 rounded-lg border border-base-300 px-4 py-3 text-sm text-base-content/70">

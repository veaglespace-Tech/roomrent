...
import { MessageSquare, Calendar, Building, ArrowRight } from "lucide-react";
...
export default function MyEnquiriesPage() {
  ...
  return (
    <div className="panel p-8">
      <h1 className="text-3xl font-extrabold text-white">My Enquiries</h1>
      <p className="mt-2 text-sm text-slate-400">Track and view inquiries sent to property owners.</p>
      ...
      <div className="mt-8 space-y-4">
        {enquiries.length > 0 ? (
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2 text-slate-400">
                    <MessageSquare className="size-4 mt-1 flex-shrink-0 text-cyan-400" />
          ...
          <div className="text-center py-12 border border-dashed border-white/10 rounded-2xl">
            ...
            <p className="text-slate-400 font-medium">No inquiries submitted yet.</p>
            <Link href="/properties" className="inline-flex items-center gap-1.5 mt-4 text-xs font-bold text-pink-400 hover:underline">
              Browse properties to inquire <ArrowRight className="size-3" />
            </Link>
          </div>
        )}
      </div>

...
import { ArrowRight, BarChart3, ChevronRight, Search, ShieldCheck } from "lucide-react";

const listingCategories = [
  { title: "Rooms", href: "/properties?type=ROOM", copy: "Shared and private room inventory." },
  ...
  { title: "Commercial", href: "/contact", copy: "Office and shop requirements." }
];

const serviceCards = [
  { icon: Search, title: "Search", copy: "Filter by locality, budget, furnishing, and occupancy." },
  { icon: ShieldCheck, title: "Verified", copy: "Focus on direct owners and clean property records." },
  { icon: BarChart3, title: "Track", copy: "Save listings, compare options, and review activity." }
];

const metrics = [
  { label: "Active listings", value: "2,400+" },
  { label: "Covered districts", value: "36" },
...
function HeroMockup() {
  return (
    <div className="surface-card overflow-hidden p-5 md:p-6">
      <div className="flex items-center justify-between gap-4 border-b border-[rgba(15,23,42,0.08)] pb-4">
        <div>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div className="surface-card p-4">
          ...
          <p className="mt-2 text-sm text-[var(--rf-muted)]">Collected across active properties.</p>
        </div>
        <div className="surface-card p-4">
          ...
          <p className="mt-2 text-sm text-[var(--rf-muted)]">Payments, renewals, and follow-ups.</p>
        </div>
      </div>
      <div className="mt-4 flex items-center justify-between gap-3 border-t border-[rgba(15,23,42,0.08)] pt-4">
        <p className="text-sm text-[var(--rf-muted)]">Recent activity: enquiry received, reminder sent, listing updated.</p>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div>
              ...
              <h1 className="mt-3 max-w-xl text-5xl font-bold leading-tight md:text-7xl">A focused rental platform for Maharashtra.</h1>
            </div>
            <p className="max-w-xl text-sm leading-7 text-[var(--rf-muted)] md:text-base">
              Built with a consistent light UI, clear navigation, aligned forms, and a compact dashboard experience.
            </p>
      ...
      <section id="properties" className="mt-16 scroll-mt-32 reveal-up">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold md:text-4xl">Browse the core inventory paths.</h2>
          </div>
        </div>
      ...
      <section className="mt-16 reveal-up">
        <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
          <div className="surface-card p-6">
            <h3 className="text-2xl font-bold">Production UI, stripped to the essentials.</h3>
            <p className="mt-2 max-w-2xl text-sm leading-7 text-[var(--rf-muted)]">
              The homepage keeps only the sections that support a real product flow and matches the same light system used across the app.
            </p>
          </div>
